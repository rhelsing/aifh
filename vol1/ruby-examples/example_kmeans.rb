...
require 'k_means' #gem install k_means (https://github.com/reddavis/K-Means)
...
#first 4 data elements
data = normalizer.result_set.map{|x| x[0..3]}
#run K-means TODO: recreate
kmeans = KMeans.new(data, :centroids => 3) #uses euclidean distance

#display result:
kmeans.view.each_with_index do |centroid, i|
  puts "Cluster #{i+1}"
  centroid.each do |elm|
    puts normalizer.original_data[elm].inspect
  end
end
